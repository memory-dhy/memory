  ...
  <div class="admin-content-body">
    <div class="am-cf am-padding am-padding-bottom-0">
      <div class="am-fl am-cf">
        <strong class="am-text-primary am-text-lg">关于我</strong> 
      </div>
    </div>
    <hr>
	<form method="post" action="../Inc/About.php" id="form1" class="am-form am-form-inline" enctype="multipart/form-data">
          ...
          <div class="am-g am-margin-top">
            ...
            <div class="am-u-sm-8 am-u-md-10">
                <div class="am-form-group am-form-icon">
                  <input type="text" class="am-input-sm" name="abstract" value="<?php echo $about['abstract']; ?>" style="width:500px;" />
                </div>
            </div>
          </div>
       <div class="am-g am-margin-top">
