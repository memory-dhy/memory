  ...
  <div class="admin-content-body">
    <div class="am-cf am-padding am-padding-bottom-0">
      <div class="am-fl am-cf">
        <strong class="am-text-primary am-text-lg">文章编辑</strong> /
        <small>文章管理</small>
      </div>
    </div>
    <hr>
      ...
      <div class="am-tabs-bd">
        <div class="am-tab-panel am-fade am-in am-active" id="tab1">
          <div class="am-g am-margin-top">
            ...
            <div class="am-u-sm-8 am-u-md-10">
                <div class="am-form-group am-form-icon">
                  <input type="text" class="am-input-sm" name="atitle" value="<?php echo $article['atitle']; ?>" style="width:220px" />
                </div>
            </div>
          </div>
          <div class="am-g am-margin-top">
            ...
            <div class="am-u-sm-8 am-u-md-10">
                <div class="am-form-group am-form-icon">
                  <input type="text" class="am-input-sm" name="athor" value="<?php echo $article['athor']; ?>" style="width:220px" />
                </div>
            </div>
          </div>
          <div class="am-g am-margin-top">
            ...
            <div class="am-u-sm-8 am-u-md-10">
                <div class="am-form-group am-form-icon" style="display: flex;overflow: auto;">
                  <?php
                      $image = json_decode($article['aimg']);
                      foreach($image as $list){
                  ?>
                  <img src="../../uploads/<?php echo $list; ?>" style="height: 100px;" />
                  <?php } ?>
                </div>
            </div>
          </div>
         <div class="am-g am-margin-top">
            ...
            <div class="am-u-sm-8 am-u-md-10">
                <div class="am-form-group am-form-icon">
                  <input type="text" class="am-input-sm" name="aabstract" value="<?php echo $article['aabstract']; ?>" style="width:220px" />
                </div>
            </div>
          </div>
          <div class="am-g am-margin-top">
            ...
            <div class="am-u-sm-8 am-u-md-10">
                <div class="am-form-group am-form-icon">
                  <script id="acontent" name="acontent" type="text/plain" style="height: 300px;"><?php echo htmlspecialchars_decode($article['acontent']); ?></script>
                </div>
            </div>
          </div>
        </div>
